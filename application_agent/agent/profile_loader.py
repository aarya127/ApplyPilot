...
def normalize_profile(profile: dict[str, Any], settings: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "field_of_study": profile.get("fieldOfStudy", ""),
        "fieldOfStudy": profile.get("fieldOfStudy", ""),
        "gpa": profile.get("gpa", ""),
        "education": profile.get("education") or profile.get("resumeFacts", {}).get("education", []),
        ...
        "work_experience": profile.get("workExperience") or profile.get("resumeFacts", {}).get("experience", []),
        "answers": answers,
